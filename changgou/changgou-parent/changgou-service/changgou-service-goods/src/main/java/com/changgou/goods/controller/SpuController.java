...
*/
    ...
    public Result putMany(@RequestBody Long[] ids){
        ...
        return  new Result(true,StatusCode.OK,"上架商品成功！",i);
    }
...
*/
     ...
     * @return
     */
    @ApiOperation(value = "Spu根据id查询商品",notes = "查询商品id",tags = {"SpuController"})
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "path", name = "id", value = "当前id", required = true, dataType = "Long"),
    })
    @GetMapping("/goods/{id}")
     ...
     *增加商品的实现
     */
    @ApiOperation(value = "Spu保存商品",notes = "保存商品",tags = {"SpuController"})
    @PostMapping("/save")
